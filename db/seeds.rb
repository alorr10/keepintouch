...
Contact.create(name: "Andrew Lorraine", contact_method: 'FB Messenger', handle: "andrew.lorraine.5", user_id: 1, last_contacted_on: "2017-09-01")
Contact.create(name: "Richard Lorraine", phone: "+12154705811", contact_method: 'Phone', user_id: 1, last_contacted_on: "2017-08-14")
Contact.create(name: "Justin Eastman", handle: "coolnormalguy", contact_method: 'FB Messenger', user_id: 1, last_contacted_on: "2017-06-14")
Contact.create(name: "Mary Jo Worthington", phone: "+2172488593", contact_method: 'Facetime', user_id: 1, last_contacted_on: "2017-08-28")